            ...
            <section className="carreras__container">
                ...
                <div className="carreras__flex" data-aos="fade-down-left" data-aos-duration="2500">
                    <div className="box" data-aos="flip-left">
                        ...
                        <p className="box__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae,
                    ...
                    <div className="box" data-aos="flip-left">
                        ...
                        <p className="box__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus tempore
